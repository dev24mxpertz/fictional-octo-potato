...
function GalleryItem({
  ...
  useEffect(() => {
    if (onScreen) updateActiveImage(index);
  }, [onScreen, index]);

  return (
    <div
      className={`gallery-item-wrapper ${onScreen ? "is-reveal" : ""}`}
      ref={ref}
    >
      <div></div>
...
export default function Gallery() {
  ...
  const handleUpdateActiveImage = (index) => setActiveImage(index + 1);
